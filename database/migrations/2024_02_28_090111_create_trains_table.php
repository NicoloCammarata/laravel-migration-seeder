...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('trains', function (Blueprint $table) {
            ...
            //Codice Treno: stringa(8) unique not null
            $table->string('code', 7)->unique();
           //Numero Carrozze: tynint unsigned null
           $table->unsignedTyniInteger('carriages_num')->nullable();
           //In orario: booleano default true
           $table->boolean('on_time')->default(true);
           //Cancellato: booleano default false
